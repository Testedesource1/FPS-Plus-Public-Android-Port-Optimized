...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'beach': //Week # - Surfs-up, Tides, Beach-Brawl
					var bg:FlxSprite = new FlxSprite(-1000, -500).loadGraphic(Paths.image('beach/beachBG','week#'));
					...
					bottomBoppers.frames = Paths.getSparrowAtlas('beach/daBois','week#');
					...
					var fgSand:FlxSprite = new FlxSprite(-600, 700).loadGraphic(Paths.image('beach/fgSand','week#'));
					fgSand.active = false;
					fgSand.antialiasing = true;
					add(fgSand);
